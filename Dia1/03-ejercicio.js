...
peliculas.forEach(function(movies, indice){
    // Creando elementos para la tabla.
    ...
    // Añadiendo elementos creados al tr
    ...
    // Añadiendo elementos dentro del html
    tdNro.innerHTML = indice+1;
    tdId.innerHTML = movies.id;
    tdTittle.innerHTML = movies.title;
    tdDate.innerHTML = movies.release_date;
    tdLanguage.innerHTML = movies.original_language;

    // Añadiendo elementos a cada celda
